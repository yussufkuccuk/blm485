<?php
 ...
 <div style="padding-right: 20px;float:right"><a href="anasayfaKullanici.php">Anasayfaya Dön <i class="fas fa-arrow-circle-left"></i></a></div>
     <div class="wrapper wrapper--w680">
         <div class="card card-5">
             ...
             <div class="card-body">
                 <form method="POST" action="ogrenciEkleKullanici1.php">
                     <table>
                         <tr>
                             <td>
